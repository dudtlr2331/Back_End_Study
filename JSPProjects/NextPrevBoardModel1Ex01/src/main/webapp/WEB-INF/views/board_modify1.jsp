		...
		<div class="contents_sub">	
				...
				<tr>
					...
					<td class="top">
						<select name="kind" class="select">
							<option value="생활" <%= kind.equals("생활") ? "selected" : "" %>>생활</option>
							<option value="여행" <%= kind.equals("여행") ? "selected" : "" %>>여행</option>
							<option value="테크" <%= kind.equals("테크") ? "selected" : "" %>>테크</option>
						</select>
					</td>
				</tr>
				<tr>
			...
			<div class="btn_area">
				<div class="align_left">
					...
					<input type="button" value="보기" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='view.do?<%= seq %>'" />
				</div>
