...
<link rel="stylesheet" type="text/css" href="./css/board.css">
	<script>
		window.onload = function() {
			const emotValue = '<%= emot %>';
			const emotRadios = document.getElementsByName('emot');
			for (let i = 0; i < emotRadios.length; i++) {
				if (emotRadios[i].value === emotValue) {
					emotRadios[i].checked = true;
					break;
				}
			}
...
<div class="con_txt">
	<form action="./modify_ok.emot" method="post" name="mfrm">
		...
		<div class="contents_sub">
			...
			<div class="btn_area">
				<div class="align_left">
					...
					<input type="button" value="보기" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='view.emot?seq=<%= seq %>'" />
				</div>
