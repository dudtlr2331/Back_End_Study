	...
	<div class="contents_sub">
		...
		<div class="btn_area">
			...
			<div class="align_right">
				...
				<input type="button" value="답글쓰기" class="btn_write btn_txt01" style="cursor: pointer;" onclick="location.href='reply.do?cpage=<%= cpage %>&seq=<%= seq %>'" />
				<input type="button" value="새글쓰기" class="btn_write btn_txt01" style="cursor: pointer;" onclick="location.href='write.do?cpage=<%= cpage %>'" />
			</div>
		</div>	
		<!--//게시판-->
	</div>
