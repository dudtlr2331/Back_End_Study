...
//    private BoardDAO2 dao;
    ...
    public ModelAndView reply(HttpServletRequest req) {
        ...
        ModelAndView modelAndView = new ModelAndView("board_reply1");
    ...
    public ModelAndView reply_ok(HttpServletRequest req) {
        System.out.println("reply_ok() 호출");
        ...
        ModelAndView modelAndView = new ModelAndView("board_reply1_ok");
        modelAndView.addObject("flag", flag);
        modelAndView.addObject("seq", to.getSeq());
